...
class Drifter():
    ...
    def __init__(self,
        ...
        min_lon=-90,
        max_lon=20,
        start_date=datetime.strftime(datetime.now()-timedelta(days=6), format='%Y-%m-%dT00:00:00Z'),
    ...
    def get(self, save_bd=True):
        ...
        if save_bd:
            ...
            self.db.feed_bd(table='data_no_stations', df=self.result, data_type=self.data_type)
        else:
            return self.result
